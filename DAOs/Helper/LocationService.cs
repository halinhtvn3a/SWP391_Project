...
namespace DAOs.Helper
{
    public class LocationService
    {
        ...
        public static async Task<double> GetRouteDistanceAsync(
            LocationModel user,
            LocationModel destination
        )
        {
            var url =
                $"http://router.project-osrm.org/route/v1/driving/{user.Longitude},{user.Latitude};{destination.Longitude},{destination.Latitude}?overview=false";

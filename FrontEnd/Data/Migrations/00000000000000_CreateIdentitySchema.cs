	...
	public partial class CreateIdentitySchema : Migration
	{
		protected override void Up(MigrationBuilder migrationBuilder)
		{
			...
			migrationBuilder.CreateTable(
				...
				columns: table => new
				{
					UserDetailId = table.Column<string>(type: "nvarchar(5)", maxLength: 5, nullable: false),
			...
			migrationBuilder.InsertData(
				...
				values: new object[,]
				{
			{ "R001", "5aed80af-db4a-4446-8134-87a58a97d1d3", "Admin", "ADMIN" },
			{ "R002", "85f6490c-0935-4545-ba72-ffbfe1dcbab7", "Staff", "STAFF" },
			{ "R003", "622b3739-8aa4-48d0-8eeb-c06ea146ad07", "Customer", "CUSTOMER" }
				});

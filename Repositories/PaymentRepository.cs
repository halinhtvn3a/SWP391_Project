...
namespace Repositories
{
    public class PaymentRepository
    {
        ...
        public async Task<(List<Payment>, int total)> GetPayments(PageResult pageResult) =>
            await _paymentDao.GetPayments(pageResult);
        ...
        public Payment GetPaymentByBookingId(string bookingId) =>
            _paymentDao.GetPaymentByBookingId(bookingId);
        ...
        public async Task<(List<Payment>, int total)> GetPayments(
            ...
            int? month,
            int? year
        ) => await _paymentDao.GetPayments(pageResult, day, month, year);
    }
}

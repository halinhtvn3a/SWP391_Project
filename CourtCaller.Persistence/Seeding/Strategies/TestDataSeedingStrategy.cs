    ...
    public class TestDataSeedingStrategy : ISeedingStrategy
    {
        ...
        public async Task<SeedingResult> SeedAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                {
                    result.Errors.Add(
                        "Cannot seed test data: Required reference data (Branches/Courts) not found"
                    );
                    return result;
                }
                ...
                var seedingTasks = new (string EntityName, Func<Task> SeedingTask)[]
                {
                    (
                        "TimeSlots",
                        () =>
                            SeedEntityAsync<TimeSlot>(
                                AppCts.SeederRelativePath.TimeSlotPath,
                                result,
                                cancellationToken
                            )
                    ),
                    (
                        "UserDetails",
                        () =>
                            SeedEntityAsync<UserDetail>(
                                AppCts.SeederRelativePath.UserDetailPath,
                                result,
                                cancellationToken
                            )
                    ),
                    (
                        "Bookings",
                        () =>
                            SeedEntityAsync<Booking>(
                                AppCts.SeederRelativePath.BookingPath,
                                result,
                                cancellationToken
                            )
                    ),
                    (
                        "Payments",
                        () =>
                            SeedEntityAsync<Payment>(
                                AppCts.SeederRelativePath.PaymentPath,
                                result,
                                cancellationToken
                            )
                    ),
                    (
                        "Reviews",
                        () =>
                            SeedEntityAsync<Review>(
                                AppCts.SeederRelativePath.ReviewPath,
                                result,
                                cancellationToken
                            )
                    ),
                    (
                        ...
                        () =>
                            SeedEntityAsync<RegistrationRequest>(
                                AppCts.SeederRelativePath.RegistrationRequestPath,
                                result,
                                cancellationToken
                            )
                    ),
                ...
                _logger.LogInformation(
                    "Test data seeding completed in {Duration}ms. Success: {Success}",

...
namespace CourtCaller.Persistence
{
	public class CourtCallerDbContextSeed(IFileReader fileReader, IApplicationDbContext dbContext)
	{
		...
		{
			await new JsonDataSeeder<Branch, DbContext>(
				_fileReader,
			...
			await new JsonDataSeeder<Court, DbContext>(
				_fileReader,
				(DbContext)_dbContext
			)
			...
			await new JsonDataSeeder<TimeSlot, DbContext>(
				_fileReader,
				(DbContext)_dbContext
			)
			...
			await new JsonDataSeeder<Booking, DbContext>(
				_fileReader,
				(DbContext)_dbContext
			)
			...
			await new JsonDataSeeder<Payment, DbContext>(
				_fileReader,
				(DbContext)_dbContext
			)
			...
			await new JsonDataSeeder<Review, DbContext>(
				_fileReader,
				(DbContext)_dbContext
			)
			...
			await new JsonDataSeeder<UserDetail, DbContext>(
				_fileReader,
				(DbContext)_dbContext
			)
			...
			await new JsonDataSeeder<Price, DbContext>(
				_fileReader,
				(DbContext)_dbContext
			)
			...
			await new JsonDataSeeder<News, DbContext>(
				_fileReader,
				(DbContext)_dbContext
			)

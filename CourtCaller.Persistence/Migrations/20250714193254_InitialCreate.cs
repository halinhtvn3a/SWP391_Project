    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    BranchId = table.Column<string>(
                        type: "nvarchar(10)",
                        maxLength: 10,
                        nullable: false
                    ),
                    BranchAddress = table.Column<string>(
                        type: "nvarchar(255)",
                        maxLength: 255,
                        nullable: false
                    ),
                    ...
                    BranchPhone = table.Column<string>(
                        type: "nvarchar(15)",
                        maxLength: 15,
                        nullable: false
                    ),
                    ...
                    BranchPicture = table.Column<string>(
                        type: "nvarchar(max)",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsHomepageSlideshow = table.Column<bool>(type: "bit", nullable: false),
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProfilePicture = table.Column<string>(
                        type: "nvarchar(500)",
                        maxLength: 500,
                        nullable: true
                    ),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BookingType = table.Column<string>(
                        type: "nvarchar(50)",
                        maxLength: 50,
                        nullable: false
                    ),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CourtName = table.Column<string>(
                        type: "nvarchar(100)",
                        maxLength: 100,
                        nullable: false
                    ),
                    CourtPicture = table.Column<string>(
                        type: "nvarchar(450)",
                        maxLength: 450,
                        nullable: true
                    ),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PaymentMessage = table.Column<string>(
                        type: "nvarchar(500)",
                        maxLength: 500,
                        nullable: false
                    ),
                    ...
                    PaymentSignature = table.Column<string>(
                        type: "nvarchar(50)",
                        maxLength: 50,
                        nullable: true
                    ),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "R001", "c88e7fb5-f782-4c32-9af5-38eb94bb84bc", "Admin", "ADMIN" },
                    { "R002", "6a3ab586-7c81-4109-bc58-2009e76b3b49", "Staff", "STAFF" },
                    { "R003", "e4d1a56d-2dee-4203-9e22-6813e39994c3", "Customer", "CUSTOMER" },
                }
            );
            ...
            migrationBuilder.CreateIndex(name: "IX_Bookings_Id", table: "Bookings", column: "Id");
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.DropTable(name: "RegistrationRequests");
            ...
            migrationBuilder.DropTable(name: "Courts");

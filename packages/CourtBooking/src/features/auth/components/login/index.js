              ...
              <div className="flex flex-col items-center w-full">
                ...
                <div className="mb-5 w-full">
                  ...
                  <button
                    ...
                    className="flex items-center justify-center bg-blue-600 text-white rounded-md px-4 py-2 w-full hover:bg-blue-700 transition-colors"
                  >
                ...
                <input
                  ...
                  required
                  className={`w-full bg-gray-100 border-none rounded-lg px-4 py-3 text-sm mb-2 outline-none ${

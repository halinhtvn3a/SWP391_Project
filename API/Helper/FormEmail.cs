    ...
    <body>
        <div class=""container"">
            <div class=""header"">
                ...
                <h4>Cảnh báo Email</h4>
            </div>
            <div class=""content"">
                <h3>Cảnh báo tài khoản của bạn</h3>
                <p>Tài khoản với Email: {email} đã phát hiện bất thường khi đăng nhập, việc bạn cần làm là cầu nguyện bởi chúng tôi cũng chưa biết code cách fix.</p>

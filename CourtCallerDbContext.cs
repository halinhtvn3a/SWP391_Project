...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        {
            ...
            {
                optionsBuilder.UseSqlServer("Server=DESKTOP-RGB0PJ4;uid=sa;pwd=12345;database=CourtCallerDb;TrustServerCertificate=True;",
                    sqlServerOptionsAction: sqlOptions =>
                    {
                        sqlOptions.EnableRetryOnFailure(
                            maxRetryCount: 5, // số lần thử lại tối đa
                            maxRetryDelay: TimeSpan.FromSeconds(30), // thời gian trễ tối đa giữa các lần thử lại
                            errorNumbersToAdd: null); // các mã lỗi bổ sung để thêm vào danh sách mặc định
                    });
            }
        }

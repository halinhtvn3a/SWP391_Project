...
namespace Services.Interface
{
    public interface IBookingService
    {
        ...
        Task<(List<Booking>, int total)> GetBookings(
        ...
        Task<Booking> AddBookingTypeFix(
            int numberOfMonths,
            string[] dayOfWeek,
            DateOnly startDate,
        ...
        Task<(decimal todayRevenue, decimal changePercentage)> GetMonthlyRevenueAsync(
            string? branchId
        );
        Task<(decimal todayRevenue, decimal changePercentage)> GetWeeklyRevenueAsync(
            string? branchId
        );

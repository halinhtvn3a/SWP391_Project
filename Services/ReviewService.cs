...
namespace Services
{
    public class ReviewService
    {
        ...
        public Review AddReview(ReviewModel reviewModel) =>
            _reviewRepository.AddReview(reviewModel);
        ...
        public List<Review> GetReviewsByBranch(string id) =>
            _reviewRepository.GetReviewsByBranch(id);
        ...
        public List<Review> SearchByDate(DateTime start, DateTime end) =>
            _reviewRepository.SearchByDate(start, end);
        ...
        public async Task<List<Review>> SortReview(
            ...
            bool isAsc,
            HelperResult.PageResult pageResult
        ) => await _reviewRepository.SortReview(sortBy, isAsc, pageResult);

        public List<decimal> GetRatingPercentageOfABranch(string branchId) =>
            _reviewRepository.GetRatingPercentageOfABranch(branchId);

...
namespace Services
{
	public class UserService
	{
		...
		public void BanUser(string id, IdentityUser user) => UserRepository.BanUser(id,user);
		
		public void UnBanUser(string id, IdentityUser user) => UserRepository.UnBanUser(id, user);
